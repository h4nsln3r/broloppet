/**
 * Bröllopskonfiguration – datum, platser, toastmasters m.m.
 * Ändra här för att uppdatera innehållet på sidan.
 */
export const WEDDING = {
  couple: "Hannes & Julia",
  dateLong: "Lördag 29 augusti 2026",
  /** ISO-datum för vigseln (används t.ex. av countdown). */
  ceremonyDateISO: "2026-08-29T14:00:00",
  ceremony: {
    place: "Hossmo kyrka",
    time: "14:00",
  },
